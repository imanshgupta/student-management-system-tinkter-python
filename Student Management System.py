...
connection.execute(" CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " ( fgh" + STUDENT_ID +
...
appLabel = tk.Label(root, text="Student Management System",
                    fg="#000000", width=35)
appLabel.config(font=("Sylfaen", 30), fg="#000000")
...
displayButton = tk.Button(root, text="Display result", fg="#000000",
